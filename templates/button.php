...
?>
<button class="ask-me-anything-button ask-me-anything-trigger-button ask-me-anything-button-<?php echo sanitize_html_class( $position ); ?>" data-target="#ask-me-anything"><?php echo $button_text; ?></button>